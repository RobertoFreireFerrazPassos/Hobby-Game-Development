...
internal class RenameScene : Scene
{
    private SingleLineTextField _textField;
    private ConfirmButton _confirmButton;

    public RenameScene(SceneManager sceneManager) : base(sceneManager)
    {
        var buttonWidth = 84;
        var buttonHeight = 36;
        ...
        var textHeight = (int)(FontAtlasUtils.MediumFont.CharHeight * scale);
    ...
    {
        FrameworkData.SpriteBatch.DrawText_MediumFont("Enter the title of your game:", new Vector2(260, 30), 1, 1f, 5f, -1);
        _textField.Draw();
        _confirmButton.Draw();
    }
